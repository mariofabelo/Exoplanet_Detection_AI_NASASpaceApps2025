      ...
      <div className="flex flex-col items-center justify-center p-4 sm:p-6 space-y-6 sm:space-y-8 min-h-screen max-w-7xl mx-auto">
        ...
        <div className="text-center space-y-2 sm:space-y-3 animate-fade-in">
          ...
          <p className="text-base sm:text-lg text-gray-700 max-w-3xl leading-relaxed px-4">
            Upload your exoplanet data to get predictions from our trained ML model.<br />
            The model will classify each object as either a <span className="font-semibold text-blue-600">CANDIDATE</span> or <span className="font-semibold text-green-600">CONFIRMED</span> exoplanet.
          </p>
        </div>
        ...
        <footer className="mt-12 pt-6 border-t border-gray-200">
          <div className="text-center space-y-3">
            ...
            <div className="flex justify-center items-center space-x-6">
              ...
              />
              <a
                href="https://github.com/mariofabelo/Exoplanet_Detection_AI_NASASpaceApps2025"
                target="_blank"
                rel="noopener noreferrer"
                className="group p-3 rounded-full bg-gray-100 hover:bg-gray-200 transition-all duration-200 hover:scale-110 shadow-md hover:shadow-lg"
